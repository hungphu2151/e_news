...
<jsp:useBean id="da_duoc_duyet" scope="request" type="java.util.List<com.example.e_news.beans.Article>"/>
...
<t:main>
  <jsp:attribute name="reader">
    ...
    <jsp:body>
        <c:choose>
            <c:when test="${da_duoc_duyet.size() == 0}">
                <div class="card-body">
            ...
            <c:otherwise>
                <div class="card">
                    <div class="card-header">
                        <h5 class="">Những bài viết đã được duyệt</h5>
                    </div>
                    <c:forEach items="${da_duoc_duyet}" var="a">
                        <div class="card-body">
                            <div class="row">
